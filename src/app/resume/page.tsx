...
export const metadata = { title: "Resume | Mangelek Gabriel" };
      ...
      <section className="relative min-h-[calc(100vh-24px)] overflow-hidden border border-line bg-card/70">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-6 p-4 md:p-8">
          <header className="flex flex-col gap-4 border-b border-line pb-5 md:flex-row md:items-start md:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.28em] text-accent">Interactive Resume</p>
              ...
              <p className="mt-4 max-w-xl text-sm font-bold leading-tight text-muted md:text-base">
                A focused CV viewer for AI, data, web, forecasting, dashboard, and portfolio proof.
              </p>
            </div>

            <Link href="/" className="w-fit border border-line px-5 py-3 text-xs font-black uppercase transition hover:border-accent hover:text-accent">
              Back Home
            </Link>
          </header>
          ...
          <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
            <aside className="space-y-4">
              <div className="border border-line bg-ink/70 p-5">
                <p className="text-xs font-black uppercase tracking-[0.22em] text-muted">Resume Actions</p>
            ...
            <section className="overflow-hidden border border-line bg-paper p-2 shadow-2xl shadow-black/40">
              ...
              <iframe src={cvPath} className="h-[78vh] w-full bg-white" title="Mangelek Gabriel Resume" />
            </section>
          </div>
        </div>
      </section>
